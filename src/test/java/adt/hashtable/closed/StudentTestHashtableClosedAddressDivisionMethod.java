...
public class StudentTestHashtableClosedAddressDivisionMethod {
    ...
    public void setUp() throws Exception {
        table1 = new HashtableClosedAddressImpl<>(PROPOSED_SIZE, HashFunctionClosedAddressMethod.DIVISION);
        ...
        table2 = new HashtableClosedAddressImpl<>(PROPOSED_SIZE, HashFunctionClosedAddressMethod.DIVISION);
    }
