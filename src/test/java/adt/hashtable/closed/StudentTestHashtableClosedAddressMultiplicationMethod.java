...
public class StudentTestHashtableClosedAddressMultiplicationMethod {
    ...
    public void setUp() throws Exception {
        table1 = new HashtableClosedAddressImpl<>(PROPOSED_SIZE, HashFunctionClosedAddressMethod.MULTIPLICATION);
        ...
        table2 = new HashtableClosedAddressImpl<>(PROPOSED_SIZE, HashFunctionClosedAddressMethod.MULTIPLICATION);
    }
    ...
    public void testInsert() {
        ...
        table2.insert(103); // nao produz colisao inserindo 1 elemento na table vazia
